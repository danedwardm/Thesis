...
const MapPicker = ({ isVisible, onClose, onSelectLocation }) => {
    ...
    if (searchValue && geocoder) {
      ...
      geocoder.geocode(searchValue, function (results) {
        if (results && results.length > 0) {
          ...
          setSelectedLocation({ lat: results[0].center.lat, lng: results[0].center.lng }); 
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black/50 z-40">
      <div className="relative w-4/5 md:w-3/4 lg:w-1/2 bg-white rounded-xl shadow-xl overflow-hidden">
        ...
        <div className="p-4">
          <h3 className="text-xl font-semibold mb-4">Select Station Address</h3>
          ...
          <div className="h-64 bg-gray-200">
            ...
            >
              ...
              />
              <MapClickHandler />
              <UpdateMapView /> {/* Update map view when selectedLocation changes */}
              {currentLocation && (
