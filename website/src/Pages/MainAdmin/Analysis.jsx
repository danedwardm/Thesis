    ...
    <>
      <div className="relative bg-second h-[100vh] w-[100vw] overflow-hidden">
        ...
        <div className="relative h-[100vh] w-[100vw] flex flex-col items-center z-30 overflow-auto overflow-x-hidden ">
          ...
          <button className="mt-4 px-4 py-2 bg-blue-500 text-white rounded" onClick={(e) => {
            e.preventDefault();
            handleGenerateReport()
          }}>{isLoading ? <div role="status">
            <svg aria-hidden="true" class="w-8 h-8 text-gray-200 animate-spin " viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
